...
void drawText() {
  ...
  text("Receives 1 classifier output message from Wekinator", 5, 15);
  text("Listening for OSC message /wek/outputs on port 12000", 5, 30);
  text("1 = Left   2 = Right   3 = Jump", 5, 45);
